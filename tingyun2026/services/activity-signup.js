...
async function listActivitySource(){const cloudActivities=await catalog.listActivityItems();return cloudActivities.length?cloudActivities:activities;}
