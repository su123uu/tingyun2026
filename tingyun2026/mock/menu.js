...
const sampleImage = assets.meal.sample;
...
const items = [
  item({ item_id: 'tea', category_key: 'package', item_type: 'package', name: '下午茶套餐', description: '山间茶席与时令茶点', specification: '1 套，含茶饮与时令茶点', details: [{ name: '崂山绿茶', quantity: '1 壶' }, { name: '时令水果', quantity: '1 盘' }, { name: '零食小吃', quantity: '1 盘' }], price: 38, member_price: null, is_available: true, image: assets.meal.teaSet, sort_order: 1 }),
