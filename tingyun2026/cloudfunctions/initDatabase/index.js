    ...
    rows: [
      {
        ...
        dishes: {
          凉菜: ['黄瓜拌', '清风醋花生'],
          热菜: ['干煸崂山参', '豆豉鲮鱼油麦菜', '崂山菇炒溜达鸡', '蒸蒸日上'],
          主食: ['米饭', '炝锅面'],
          汤品: ['排骨玉米药膳汤'],
        },
        image_url: 'cloud://cloud1-d6gzs6wuu4b4e902e.636c-cloud1-d6gzs6wuu4b4e902e-1437151055/dining-standards/餐标示例.png',
        is_enabled: true,
        sort_order: 10,
      },
      {
        ...
        summary: '四凉十热，山居时令菜品搭配，适合雅聚宴请',
        dishes: {
          凉菜: ['红油留香鸡', '白玉脆蛰皮', '清风醋花生', '手扒海米马家沟芹菜'],
          热菜: ['蒜爆炖泉水鱼', '崂山菇炒溜达鸡', '排骨玉米药膳汤', '香茅草焗牛嫩肩', '碧笋百花炒虾仁', '黑猪肉烩香芋', '金玉槐香', '金缕崂山参', '豆豉鲮鱼油麦菜', '蒸蒸日上'],
          果品: ['山间时令水果'],
          主食: ['炝锅面'],
        },
        image_url: 'cloud://cloud1-d6gzs6wuu4b4e902e.636c-cloud1-d6gzs6wuu4b4e902e-1437151055/dining-standards/餐标示例.png',
      ...
      },
      {
        ...
        summary: '位上辽参与山海鲜味入席，适合重要聚会',
        dishes: {
          位上: ['金沫烹辽参'],
          凉菜: ['云涧卤牛腱', '玉女黄瓜拌鲜鲍', '山野清欢椿豆腐', '手扒海米马家沟芹菜'],
          热菜: ['蒜爆泉水鱼', '崂山菇炖溜达鸡', '香茅草焗牛嫩肩', '避风塘金酥大虾', '碧笋百花炒虾仁', '排骨玉米药膳汤', '金玉槐香', '金缕崂山参', '豆豉鲮鱼油麦菜', '蒸蒸日上'],
          果品: ['山间时令水果'],
          主食: ['山野水饺'],
        },
        image_url: 'cloud://cloud1-d6gzs6wuu4b4e902e.636c-cloud1-d6gzs6wuu4b4e902e-1437151055/dining-standards/餐标示例.png',
      ...
      },
      {
        ...
        name: '停云',
        price_per_person: 368,
        summary: '位上菜、六凉十二热，讲究食材与摆盘，适合贵宾宴请',
        dishes: {
          位上: ['御膳一品辽参', '金蝉意式煎鲈鱼'],
          凉菜: ['云涧卤牛腱', '三文鱼芒果塔壳', '鲜萃捞汁海味', '百香果渍木瓜'],
          热菜: ['山野焖香鹅', '红韵酥鸡', '香茅草焗牛嫩肩', '御味红煨猪手', '避风塘金酥大虾', '碧笋百花炒虾仁', '椿韭炒海肠', '排骨松茸药膳汤', '豆豉鲮鱼油麦菜', '蒜爆泉水鱼', '金玉槐香', '蒸蒸日上'],
          主食: ['地瓜面野菜包子'],
        },
        image_url: 'cloud://cloud1-d6gzs6wuu4b4e902e.636c-cloud1-d6gzs6wuu4b4e902e-1437151055/dining-standards/餐标示例.png',
        is_enabled: true,
    ...
    rows: [
      {
        ...
        value: {
          order_statuses: ['preparing', 'completed'],
          guest_unpaid_order_status: 'unpaid',
          paid_order_status: 'preparing',
          member_payment_status: 'offline_pending',
        ...
        description: '点餐主状态使用 order_status：未支付、制作中、已完成；所有支付与线下核对状态统一记录在 payment_status；kitchen_status 仅兼容旧数据。',
        is_enabled: true,
        sort_order: 10,
      },
    ],
